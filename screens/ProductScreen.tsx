...
const ProductScreen = () => {
  ...
  return (
    <SafeAreaProvider style={{padding: wp(4), paddingTop: hp(6)}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View
          style={[StyleGuide.row, {marginVertical: hp(1), marginLeft: wp(1)}]}>
          <Image
          ...
          <Text
            style={[
              StyleGuide.regularText,
              {color: StyleGuide.colors.gray, marginLeft: 10},
            ]}>
            {params.item.rating}
          </Text>
          <Text
          ...
          {params.item.sizes.map((size: any, index: number) => (
            <TouchableOpacity
              ...
              style={{
                ...
                marginHorizontal: 5,
                backgroundColor:
                  activeSize === index ? StyleGuide.colors.primary : null,
              }}>
              <Text
                style={[
                  StyleGuide.semiText,
        ...
        <View
          ...
          <Text style={[StyleGuide.boldText, {fontSize: 32, marginTop: hp(1)}]}>
            $ {params.item.price}
          </Text>
          <TouchableOpacity
            style={[
